...
\extrainfo{\href{}{Google Scholar}}                 % optional, remove / comment the line if not wanted
...
\hspace{1em} Robot Perception · Multi-Robot Control · Reinforcement Learning · Autonomous Systems
\vspace{-6pt}
...
\vspace{-1 pt}
\item Robust Finite-Time Control of Multi-Agent Swarms, \textit{IEEE American Control Conference (ACC)}, 2027, Manuscript in preparation
\vspace{-1.5 pt}
\end{itemize}
\vspace{-15 pt}
...
Scholar}}{[TITLE for MS THESIS]}{}{Prof. Aamir Ahmad, IFR, Universität Stuttgart}{ \setlength{\itemindent}{.2in} \setlength\itemsep{.3em}
\item 1
\vspace{-1 pt}
\item 2
\vspace{-1 pt}
...
\cventry{(Jul 2026 - Aug 2026)}{\textbf{RobotX 2026 Fellow}}{Rule-Constrained Adversarial Scenario Generation}{}{Prof. Emilio Frazzoli, IDSC, ETH Zürich}{ \setlength{\itemindent}{.2in} 
...
\vspace{-1 pt}
\item Demonstrated that \textbf{feasibility learning} can serve as a \textbf{reliable surrogate} for learning and enforcing rules and constraints
\vspace{-1 pt}
\item Extended the \textbf{FREA} framework with feasibility-guided RL, reducing rule violations while preserving adversarial behaviour
\vspace{-1.5 pt}
}

\cventry{(Sept 2025 - Sept 2026)}{Guide: Prof. Anuj Kumar Tiwari, ME Dept., IIT Madras}{Robust Finite-Time Control of Multi-Agent Swarms}{\href{put link}{\textcolor{blue}{Project Link}}}{}{ \setlength{\itemindent}{.2in} \setlength\itemsep{.3em}
...
\vspace{-1 pt}
\item Derived \textbf{super-linear disturbance attenuation} for centroid tracking using finite-time sliding-mode control
\vspace{-1.5 pt}
}

\cventry{(Mar 2026 - May 2026)}{Guide: Dr. Sudarsun Santhiappan, DSAI Dept., IIT Madras}{Multi-View 3D Scene Reconstruction Pipeline for Robotic Perception}{\href{https://github.com/yash-purswani/MLOps-Project-ME22B214}{\textcolor{blue}{Project Link}}}{}{ \setlength{\itemindent}{.2in} 
\item Built a \textbf{multi-view 3D reconstruction} pipeline from unordered images using \textbf{SfM}, feature matching and dense reconstruction
\vspace{-1 pt}
\item Estimated \textbf{camera trajectories} and dense point clouds using multi-view geometry for robotic scene understanding
\vspace{-1 pt}
\item Developed an \textbf{end-to-end scalable} pipeline for reconstructing real-world 3D environments and containerized deployment
\vspace{-1.5 pt}
}
...
\item Developed an \textbf{Autonomous Road Dust Collection Robot} for unmanned operations in sub-urban environments
\vspace{-1 pt}
\item Implemented 3D LiDAR-based odometry, and mapping using \textbf{FAST-LIO2} and \textbf{NDT-based localization} for pose estimation
\vspace{-1 pt}
\item Incorporated \textbf{Lanelet-based} semantic road modelling for path planning and enable context-aware autonomous navigation
\vspace{-1 pt}
\item Performed system \textbf{performance evaluation} and \textbf{failure-mode analysis} using time-series sensor data and simulation logs
\vspace{-1.5 pt}
}
...
\item Designed an \textbf{optimal control} framework for UAV--UGV rendezvous and \textbf{in-motion refuelling} under non-linear dynamics
\vspace{-1 pt}
\item Developed a trajectory-tracking and \textbf{aggressiveness-index-based} control strategy enabling \textbf{tunable rendezvous} behaviour
\vspace{-1 pt}
...
\item Developed and fully deployed a \textbf{ROS-based software} on an electric golf cart, turning it into a \textbf{Driverless Institute Shuttle}
\vspace{-1 pt}
\item Achieved \textbf{98.3\% accuracy} using 3D LiDAR–camera sensor fusion for precise object classification and distance estimation
\vspace{-1 pt}
\item Leveraged realistic \textbf{CARLA} and \textbf{Gazebo} simulations to conduct comprehensive testing of the software subsystem for BOLT
\vspace{-1.5 pt}
}
...
\item Developed a \textbf{ROS2-based navigation} stack integrating \textbf{Nav2}, SLAM, and sensor fusion for autonomous navigation
\vspace{-1 pt}
...
\item Led a \textbf{30+} member team, overseeing software architecture, development, and validation of autonomous robots
\vspace{-1.5 pt}
\end{itemize}
